...
const IndividualFeeDetailsHeader: React.FC<Props> = ({studentMasterData}) => {
  return (
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography level="title-sm">
              ₹{studentMasterData.transportation_fee}
            </Typography>
          </div>
          <div
            style={{
          ...
          >
            ...
            <Typography level="title-sm">
              ₹{studentMasterData.computer_fee}
            </Typography>
          </div>
        </div>
      </div>
